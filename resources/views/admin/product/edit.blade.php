            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_quantity" value="{{ old('product_quantity', $product->product_quantity) }}">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_price" placeholder="販売価格" value="{{ old('selling_price', $product->selling_price) }}">
                </div>
              </div>
                ...
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" name="brand_id">
                    ...
                    @foreach($brands as $brand)
                      <option value="{{ $brand->id }}" {{ $brand->id == old('brand_id', $product->brand_id) ? 'selected' : '' }}>{{ $brand->brand_name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-4">
                ...
                <input class="form-control" type="text" name="product_size" id="size" data-role="tagsinput" value="{{ old('product_size', $product->product_size) }}">
                </div>
              </div>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_color" id="color" data-role="tagsinput" value="{{ old('product_color', $product->product_color) }}">
                </div>
              </div>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="discount_price" value="{{ old('discount_price', $product->discount_price) }}">
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" name="video_link" value="{{ old('video_link', $product->video_link) }}">
                </div>
              </div>
            </div>
            <br>
                ...
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    @if ($product->storage_product_image_one)
                      <img src="{{ Storage::disk('s3')->url($product->image_one) }}" alt="" height="80px" width="130px">
                    @else
                ...
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    @if ($product->storage_product_image_two)
                      <img src="{{ Storage::disk('s3')->url($product->image_two) }}" alt="" height="80px" width="130px">
                    @else
                      <img src="{{ asset('/panel/assets/images/noimage.png') }}" alt="" height="80px" width="130px">
                    @endif
                ...
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    @if ($product->storage_product_image_three)
                      <img src="{{ Storage::disk('s3')->url($product->image_three) }}" alt="" height="80px" width="130px">
                    @else
                      <img src="{{ asset('/panel/assets/images/noimage.png') }}" alt="" height="80px" width="130px">
                    @endif
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                  ...
                  <input type="checkbox" name="best_rated" value="1" {{ old('best_rated', $product->best_rated) ==  1 ? 'checked' : ''}}>
                  <span>最高評価</span>
                </label>
              </div>
