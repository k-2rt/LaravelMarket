            ...
            <div class="row mg-b-25">
              <div class="col-lg-5 offset-lg-1">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text"  name="post_title_ja" placeholder="タイトルを入力してください" value="{{ old('post_title_ja')
                }}">
                </div>
              </div>
                ...
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" name="post_category_id">
                    ...
                    @foreach($article_categories as $category)
                      <option value="{{ $category->id }}" {{ old('post_category_id') ==  $category->id ? 'selected' : ''}}>{{ $category->category_name_ja }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control article_text" id="" name="details_ja">{!! old('details_ja')
                  !!}</textarea>
                </div>
              </div>
