						...
						<div class="tabbed_container">
								...
								<div class="featured_slider slider">
									...
									@foreach($trend_products as $trend_product)
										...
										<div class="featured_slider_item">
											<div class="border_active"></div>
											<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
												<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($trend_product->image_one) }}" alt="" height="120px" width="100px"></div>
												<div class="product_content">
													@if($trend_product->discount_price === NULL)
														<div class="product_price discount">￥{{ number_format($trend_product->selling_price) }}</div>
													@else
														<div class="product_price discount">￥{{ number_format($trend_product->discount_price) }}<span>￥{{ number_format($trend_product->selling_price) }}</span></div>
													@endif
													<div class="product_name"><div><a href="product.html">{{ $trend_product->product_name }}</a></div></div>
													<div class="product_extras">
														<div class="product_color">
															<input type="radio" checked name="product_color" style="background:#b19c83">
															<input type="radio" name="product_color" style="background:#000000">
												...
												<ul class="product_marks">
													...
													@else
														<li class="product_mark product_discount">
															{{ $trend_product->caluculateDiscountPercent() }}%
														</li>
													@endif
												</ul>
											</div>
							...
							<div class="product_panel panel">
								<div class="featured_slider slider">
									...
									<!-- Slider Item -->
									@foreach($best_rated_products as $best_product)
										<div class="featured_slider_item">
											<div class="border_active"></div>
											<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
												<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($best_product->image_one) }}" alt="" height="120px" width="100px"></div>
												<div class="product_content">
													@if($best_product->discount_price === NULL)
														<div class="product_price discount">￥{{ number_format($best_product->selling_price) }}</div>
													@else
														<div class="product_price discount">￥{{ number_format($best_product->discount_price) }}<span>￥{{ number_format($best_product->selling_price) }}</span></div>
													@endif
													<div class="product_name"><div><a href="product.html">{{ $best_product->product_name }}</a></div></div>
													<div class="product_extras">
														<div class="product_color">
															<input type="radio" checked name="product_color" style="background:#b19c83">
															<input type="radio" name="product_color" style="background:#000000">
												...
												<ul class="product_marks">
													...
													@else
														<li class="product_mark product_discount">
															{{ $best_product->caluculateDiscountPercent() }}%
														</li>
													@endif
												</ul>
											</div>
