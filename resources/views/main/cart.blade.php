              ...
              <ul class="cart_list">
                @foreach ($cart as $item)
                  <li class="cart_item clearfix">
                    <div class="cart_item_image text-center"><a href="{{ route('product.detail', ['id' => $item->id, 'product_name' => $item->name]) }}"><img src="{{ Storage::disk('s3')->url( $item->options->image  ) }}" alt="" height="115px" width="115px"></a></div>
