        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="contact_form_container login_form" style="margin-bottom: 40px;">
                    ...
                    <a href="{{ url('/login/redirect/facebook') }}" class="btn btn-primary btn-block" style="display: none;"><i class="fab fa-facebook-square"></i> Facebook でログイン</a>
                    <a href="{{ url('/login/redirect/google') }}" class="btn btn-danger btn-block" style="display: none;"><i class="fab fa-google"></i> Google でログイン</a>
                </div>
